...
UravxBuCwNMpYWTzKhPn=Fore.BLUE
...
try:
 ...
 def UravxBuCwNMpYWTzKhPt():
  ...
  UravxBuCwNMpYWTzKhPI(" 🐞AutoClaim ZcashClickBot🐞 ".center(40,' '))
  UravxBuCwNMpYWTzKhPI(''.rjust(50,'-'))
  UravxBuCwNMpYWTzKhPI("Telegram : t.me/mabini")
  UravxBuCwNMpYWTzKhPI(''.rjust(50,'-'))
  UravxBuCwNMpYWTzKhPI("Facebook : Jonh mabine")
  UravxBuCwNMpYWTzKhPI(''.rjust(50,'-'))
  UravxBuCwNMpYWTzKhPI("Created : Damang")
  UravxBuCwNMpYWTzKhPI(''.rjust(50,'-'))
  UravxBuCwNMpYWTzKhPI(UravxBuCwNMpYWTzKhPq+"Youtube Channel : Termux Tricks and tut".center(50,' '))
  UravxBuCwNMpYWTzKhPI(''.rjust(50,'-'))
 async def UravxBuCwNMpYWTzKhPF():
  ...
  if UravxBuCwNMpYWTzKhPg(UravxBuCwNMpYWTzKhPs)<2:
   ...
   UravxBuCwNMpYWTzKhPI("phone_number must be write in internasional format (example: +62xxxxxx)")
   UravxBuCwNMpYWTzKhRA(1)
  UravxBuCwNMpYWTzKhPI(UravxBuCwNMpYWTzKhPn+"Welcome🕷️",end="\n\n")
  ...
  if me.username=='bagas_q' or me.id==415792043 or me.id==611711558:
   ...
   try:
    ...
    if UravxBuCwNMpYWTzKhcJ.creator:
     ...
     if tt:
      UravxBuCwNMpYWTzKhcO(UravxBuCwNMpYWTzKhcJ.username+' Use at your own risk')
   ...
   if UravxBuCwNMpYWTzKhRt(UravxBuCwNMpYWTzKhcb)is not UpdateShortMessage:
    if UravxBuCwNMpYWTzKhRk(UravxBuCwNMpYWTzKhcb.message,'reply_markup')and UravxBuCwNMpYWTzKhRt(UravxBuCwNMpYWTzKhcb.message.reply_markup)is ReplyInlineMarkup:
     ...
     if UravxBuCwNMpYWTzKhco is not UravxBuCwNMpYWTzKhPH:
      UravxBuCwNMpYWTzKhcg(UravxBuCwNMpYWTzKhPq+'Please wait :)')
